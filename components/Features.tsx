  ...
  const features = [
    {
      ...
      description: 'Built on OTEL standard. Zero vendor lock-in. Send traces to Lumina, Datadog, and Grafana simultaneously.',
    ...
    },
    {
      ...
      description: 'Trace the entire pipeline from user request through embedding, vector DB, reranking, to LLM generation.',
    ...
    },
    {
      ...
      description: 'The only platform where you can query: "cost > $0.50 AND latency > 2s AND semantic_score < 0.8"',
    ...
    },
    {
      ...
      description: 'One-click replay of real requests against new prompts or models. Semantic diffing shows exactly what changed.',
    ...
    },
    {
      ...
      description: 'Alert when endpoints get expensive AND quality degrades—in under 500ms. Hybrid hash + LLM evaluation.',
    ...
    },
    {
      ...
      description: 'NATS JetStream, PostgreSQL/ClickHouse, sub-500ms alerting. Built by engineers who scaled fintech systems.',
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Not another dashboard for data scientists. Production-grade tooling that plugs into your DevOps workflow.
          </p>
        </div>
