  ...
  const problems = [
    {
      ...
      description: 'OpenAI bill jumped 300% with zero visibility into which endpoints, users, or features are burning cash.',
      impact: '$500k+/month wasted'
    },
    {
      icon: '🐛',
      title: 'Silent Semantic Failures',
      description: 'LLM responses degrade but monitors don\'t fire. You learn about quality issues from customer complaints.',
      impact: '4 hour MTTD'
    },
    {
      icon: '📦',
      title: 'RAG Black Boxes',
      description: 'Vector DB returns low-quality chunks but you have no visibility until production breaks.',
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Your AI Stack is Failing Silently
          </h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Backend engineers inherited AI systems but lack the observability tools
            to maintain them with the same rigor as microservices.
          </p>
        </div>
            ...
            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-bold mb-2">The Current Tooling Gap</h3>
                              <p className="text-gray-400 max-w-2xl">
                                ...
                                but these tools don&apos;t understand semantic degradation, token costs, or hallucination detection.
                              </p>            </div>
