  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Deployment Guide</h1>
        <p className="text-xl text-gray-600 mb-8">
          Deploy Lumina to production environments
        </p>

        <div className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-8">
          <p className="text-gray-700 mb-4">
            For complete deployment guides, please visit the main repository:
          </p>
          <Link
          ...
          >
            View Deployment Docs on GitHub
          </Link>
        </div>
      </div>
    </div>
